...
[![NPM](https://nodei.co/npm/google-adwords-kogi.png?downloads=true)](https://nodei.co/npm/google-adwords-kogi/)
[![NPM](https://nodei.co/npm-dl/google-adwords-kogi.png?months=3&height=2)](https://nodei.co/npm/google-adwords-kogi/)

[![Dependency Status](https://david-dm.org/therebelrobot/google-adwords-kogi.svg)](https://david-dm.org/therebelrobot/google-adwords-kogi)
[![Code Climate](https://codeclimate.com/github/therebelrobot/google-adwords-kogi/badges/gpa.svg)](https://codeclimate.com/github/therebelrobot/google-adwords-kogi)
[![Test Coverage](https://codeclimate.com/github/therebelrobot/google-adwords-kogi/badges/coverage.svg)](https://codeclimate.com/github/therebelrobot/google-adwords-kogi)

A Node.js driver for Google Adwords Reporting API (v201506)
...
To install google-adwords-kogi, run

```bash
npm install google-adwords-kogi
```

then include in your file the following:

```javascript
var ga = require('google-adwords-kogi');
```
