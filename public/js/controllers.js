...
function DashboardController($scope,$timeout,generator) {
    ...
    $scope.gridsterOptions = {
        ...
        resizable: {
            ...
            resize: function (event, $element, widget) {
                ...
                else console.log('not working you idiot');
            },
            ...
            stop: function (event, $element, widget) {
                $timeout(function () {
                    if (widget.chart.api) widget.chart.api.update();
                    else console.log('not working you idiot stop');
                }, 400)
            }
        }
...
function WidgetSettingsController($scope,$timeout,$uibModalInstance, widget,generator) {
    $scope.widget = widget;
