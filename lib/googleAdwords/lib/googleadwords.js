 ...
 */
exports.GoogleAdwords = function (spec, my) {
  my = my || {}
  spec = spec || {}
  ...
  my.auth = {}
  my.agent = spec.agent
  my.host = spec.host || 'https://adwords.google.com/api/adwords/reportdownload/v201506'
  ...
  self.use = function (options) {
      if (typeof options === 'object') {
        ...
        } else if(options.developerToken && options.accessToken && options.clientCustomerID) {
          my.limit = null
          my.remaining = null
          my.auth.accessToken = options.accessToken || null
          my.auth.clientCustomerID = options.clientCustomerID
